...
#         points_3d = points_3d_all[select_range[ii]:select_range[ii+1],:]
...
#         depths = points_cam[2, :]
#         # print(depths.shape, fx, fy)
#         depth_z.extend(depths)
...
#         fx = intrin[0,0]
#         fy = intrin[1,1]
#         # fx = 589.1658210754395
#         # fy = 589.1658210754395
