...
class SceneData:
    ...
    def set_cameras(self, ori_size, intrinsics):
        ...
        # for i, K in enumerate(intrinsics, start=self.index):  # Starting index at 1
        #     camera_id = i
        #     scale_factor_x = width / 2 / K[0, 2]
        #     scale_factor_y = height / 2 / K[1, 2]
        #     self.cameras[camera_id] = Camera(
        ...
        #     for i in range(len(intrinsics)+1, self.size + 1):
