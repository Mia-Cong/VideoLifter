...
def render(
    ...
    confidence = pc.confidence if pipe.use_confidence else torch.ones_like(pc._opacity)
    ...
    if camera_pose.requires_grad and not rel_w2c.requires_grad:
    ...
    gaussians_rot_trans = quadmultiply((camera_pose.squeeze(0))[:4], gaussians_rot)
    # gaussians_rot_trans = gaussians_rot
