...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, args):
    sparse_recon_res_path = os.path.join(args.sparse_image_folder, f"sparse/0/sparse_{args.n_views}_ga_grid_filtered_one.pkl")
    ...
    print(sparse_extrinsics, len(sparse_all_pair_point_clous))
